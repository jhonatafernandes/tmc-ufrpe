  ...
  if (ck_1_1) {
    ...
    if (ck_1_2_1) {
      ...
      if (ck_1_3_1_1) {
        ...
        estate_St_Maintain = 3;
        v_23 = estate_St_Maintain;
...
void Atividade3__twovens_step(int finish, int start, int c, int cold,
  ...
  int power_1_St_1_Reheat;
  int estate_1_St_1_Reheat;
  int nr_St_1_Maintain;
  int ns_St_1_Maintain_3;
  int ns_St_1_Maintain_2;
  int ns_St_1_Maintain_1;
  int power_1_St_1_Maintain;
  int estate_1_St_1_Maintain;
  int nr_St_1_Heat;
  int ns_St_1_Heat_3;
  int ns_St_1_Heat_2;
  int ns_St_1_Heat_1;
  int power_1_St_1_Heat;
  int estate_1_St_1_Heat;
  int nr_St_1_Standby;
  int ns_St_1_Standby_3;
  int ns_St_1_Standby_2;
  int ns_St_1_Standby_1;
  int power_1_St_1_Standby;
  int estate_1_St_1_Standby;
  int nr_St_1_Off;
  int ns_St_1_Off_3;
  int ns_St_1_Off_2;
  int ns_St_1_Off_1;
  int power_1_St_1_Off;
  int estate_1_St_1_Off;
  int ck_2_3;
  int ck_2_2;
  int ck_2_1;
  int v_21_2_0;
  ...
  if (ck_2_1) {
    ...
    if (ck_2_2_1) {
      ck_2_3_1_1 = ck_2_3;
      if (ck_2_3_1_1) {
        estate_1_St_1_Heat = 5;
        power_1_St_1_Heat = 1500;
        nr_St_1_Heat = false;
        ns_St_1_Heat_1 = true;
        ns_St_1_Heat_2 = true;
        ns_St_1_Heat_3 = true;
        v_76 = estate_1_St_1_Heat;
        v_81 = power_1_St_1_Heat;
        v_101 = nr_St_1_Heat;
        v_86 = ns_St_1_Heat_1;
        v_87 = ns_St_1_Heat_2;
        v_88 = ns_St_1_Heat_3;
      } else {
        estate_1_St_1_Maintain = 3;
        v_76 = estate_1_St_1_Maintain;
        power_1_St_1_Maintain = 300;
        v_81 = power_1_St_1_Maintain;
      ...
      if (ck_2_3_1_0) {
        ...
        estate_1_St_1_Off = 1;
        v_77 = estate_1_St_1_Off;
        power_1_St_1_Off = 0;
        v_82 = power_1_St_1_Off;
        nr_St_1_Off = false;
        v_102 = nr_St_1_Off;
        ns_St_1_Off_1 = true;
        v_89 = ns_St_1_Off_1;
    ...
    if (ck_2_2_0) {
      ...
      ck_2_3_0_0 = ck_2_3;
      if (ck_2_3_0_0) {
        estate_1_St_1_Reheat = 4;
        v_79 = estate_1_St_1_Reheat;
        power_1_St_1_Reheat = 1000;
        v_84 = power_1_St_1_Reheat;
        ...
        estate_1_St_1_Standby = 2;
        power_1_St_1_Standby = 0;
        nr_St_1_Standby = false;
        ns_St_1_Standby_1 = false;
        ns_St_1_Standby_2 = false;
        ns_St_1_Standby_3 = false;
        v_79 = estate_1_St_1_Standby;
        v_84 = power_1_St_1_Standby;
